                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #78a9e1; background-image: url('images/bg_cart_2.png'); background-position: top center; background-repeat: no-repeat; color: #000000; width: 650px;"
                                        width="650">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:38px;"><strong><span
                                                                                        style="font-size:38px; color:#0f4f94;">SOLICITUD
                                                                                        DE SEGURO</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:20px;">Detalle de
                                                                                Pedido:</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                                ...
                                                                                <div class="txtTinyMce-wrapper"
                                                                                    ...
                                                                                    <p
                                                                                        ...
                                                                                        <span style="font-size:34px;">
                                                                                            <span
                                                                                                style="color:#0f4f94;font-size:34px;">
                                                                                                <strong>
                                                                                                    <span
                                                                                ...
                                                                                <div class="txtTinyMce-wrapper"
                                                                                    ...
                                                                                    <p
                                                                                        ...
                                                                                        <span style="font-size:18px;">
                                                                                            ...
                                                                                            {{ $datos['commodity'] }} <br>
                                                                                            Suma Asegurada: U$
                                                                                            {{ $datos['suma_asegurada'] }} <br>
                                                                                            Transporte :
                                                                                            {{ $datos['truck_transport'] }} <br>
                                                                                            Chofer:
                                                                                            {{ $datos['truck_driver'] }} <br>
                                                                                            DNI:
                                                                                            {{ $datos['truck_document'] }} <br>
                                                                                            Celular:
                                                                                            {{ $datos['driver_phone'] }} <br>
                                                                                            Tractor:
                                                                                            {{ $datos['truck_domain'] }} <br>
                                                                                            Trailer:
                                                                                            {{ $datos['truck_trailer'] }} <br>
                                                                                            Satelital:
                                                                                            {{ $datos['truck_device'] }} <br>
                                                                                            Origen:
                                                                                            {{ $datos['load_place'] }} <br>
                                                                                            Destino:
                                                                                            {{ $datos['download_place'] }} <br>
                                                                                            Documento de Referencia:
                                                                                            {{ $datos['reference_doc'] }} <br>
                                                                                            Fecha de Carga:
                                                                                            {{ $datos['load_date'] }} <br>
                                                                                            Observaciones: <br>
                                                                                            {{ $datos['observation_customer'] }}
                                                                                        </span>
                                                                                        <br />
                                                                                    </p>
                                                                                    <p
                                                                                        ...
                                                                                        <span style="font-size:15px;">
                                                                                            ...
                                                                                            <span
                                                                                                ...
                                                                                                <strong>
                                                                                                   <a href="mailto:{{ $datos['email'] }}"></a> {{ $datos['email'] }}
                                                                                                </strong>
                                                                                            </span>
                                                                                    </p>
                                                                                </div>
