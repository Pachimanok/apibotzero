                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="line-height:10px"><img alt="Image"
                                                                        ...
                                                                        src="https://apittl.botzero.ar/public/image/logoBotZero.svg"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d6f0d8; background-image: url('images/bg_cart_2.png'); background-position: top center; background-repeat: no-repeat; color: #000000; width: 650px;"
                                        width="650">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:38px;"><strong><span
                                                                                        style="font-size:38px; color:#10943c;">CARGA
                                                                                        EN ZONA DE DESCARGA.</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 12px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #7b8880; line-height: 1.2;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                                ...
                                                                                <div class="txtTinyMce-wrapper"
                                                                                    ...
                                                                                    <p style="margin: 0; font-size: 12px; text-align: center;">
                                                                                        <span style="font-size:34px;">
                                                                                            <span style="color:#1d944e;font-size:34px;">
                                                                                                <strong>
                                                                                        ...
                                                                                        <p style="margin: 0; font-size: 12px; text-align: center;">
                                                                                            <span style="font-size:px; color: gray; text-align: center;">
                                                                                                {{$datos['booking']}}
                                                                                            </span>
                                                                                        </span>
                                                                                    </p>
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <div style="font-family: sans-serif">
                                                                                <div class="txtTinyMce-wrapper"
                                                                                    ...
                                                                                    <p
                                                                                        style="margin: 4%; font-size: 14px; text-align: center; mso-line-height-alt: 27px;">
                                                                                    ...
                                                                                    {{-- <div style="text-align: center;">
                                                                                        <a href="" style="margin-top: 2rem;">VER EN EL MAPA</a>
                                                                                    </div> --}}
