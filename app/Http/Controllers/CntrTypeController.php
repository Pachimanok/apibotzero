...
class CntrTypeController extends Controller
{
     ...
     *
     * @param  \App\Http\Requests\StoreTypeCntrRequest  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Models\TypeCntr  $typeCntr
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        $cntrType = DB::table('cntr_types')->where('id','=',$id)->get();
        return $cntrType;
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(TypeCntr $typeCntr)
    {
        //
    }
     ...
     *
     * @param  \App\Http\Requests\UpdateTypeCntrRequest  $request
     * @param  \App\Models\TypeCntr  $typeCntr
     * @return \Illuminate\Http\Response
     */
